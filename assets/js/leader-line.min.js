...
var LeaderLine = (function() {
    ...
    c = (function() {
      ...
      return {
        add: function(n, e, t, a, i, o, l) {
          ...
          if (('string' == typeof i && (i = x[i]), (n = n || function() {}), t < b))
            s = [E(0, 0), E(1, 1)]
          else {
            if (
              ((u = b / t), (s = [E(0, 0)]), 0 === i[0] && 0 === i[1] && 1 === i[2] && 1 === i[3])
            )
            ...
            U = function(e, t, n, a, i, o, l, r, s, u) {
              ...
              if (Math.abs(I) > (120 * Math.PI) / 180) {
                var C = c,
                  ...
                  A = a
                ;(c =
                  s && p < c ? p + ((120 * Math.PI) / 180) * 1 : p + ((120 * Math.PI) / 180) * -1),
                  (n = d + i * Math.cos(c)),
                  (a = f + o * Math.sin(c)),
              ...
              return (
                e.forEach(function(e) {
                  if ('M' === e.type) {
                    ...
                    if (0 === p || 0 === c)
                      S.push({ type: 'C', values: [v, E, t, n, t, n] }), (v = t), (E = n)
                    else if (v !== t || E !== n)
  ...
  function fe(e) {
    ...
    function l(e) {
      ...
      return (
        n &&
          ((t = parseFloat(n[1])),
          n[2] ? (t = 0 <= t && t <= 100 ? t / 100 : 1) : (t < 0 || 1 < t) && (t = 1)),
        t
      )
    }
    return (
                ...
                if (n[0] && n[1])
                  return (
                    y(h[1], h[0])
                      ...
                      ? u[0].push(h[0])
                      : u[0].push(
                          'x' === o[0] ? { x: h[1].x, y: h[0].y } : { x: h[0].x, y: h[1].y }
                        ),
                    !1
                  )
                n[0] !== n[1]
    ...
    t.line &&
          ...
          b.plug_enabled &&
            [0, 1].forEach(function(n) {
              ...
              We(E, k.plug_enabledSE, n, (x = b.plug_enabledSE[n]), w.apl_plug_enabledSE) &&
                ((E.plugsFace.style[a.prop] = x ? 'url(#' + E.plugMarkerIdSE[n] + ')' : 'none'),
                (O = !0)),
                b.plug_enabledSE[n] &&
      ...
      (ee.viewBox =
        ...
        ['x', 'y', 'width', 'height'].forEach(function(e) {
          ...
          ;(t = G[e]) !== D[e] &&
            ((z[e] = D[e] = t),
            (j[oe[e]] = t + ('x' === e || 'y' === e ? N.bodyOffset[e] : 0) + 'px'),
            (H = !0))
        }),
        H)),
      (ee.mask =
  ...
  function je(e, t, n, a) {
    ...
    ;(o.show_on = t),
      n &&
        g[n] &&
        ((o.show_effect = n), (o.show_animOptions = ze(k(a) ? a : {}, g[n].defaultAnimOptions))),
  ...
  function Ze(s, u) {
    ...
    i &&
      ...
      (!(function(a, e) {
        ...
        ;(a.pathList = {}),
          ...
          (a.plugMarkerSE = [0, 1].map(function(e) {
            ...
            return (
              ue && (t.markerUnits.baseVal = SVGMarkerElement.SVG_MARKERUNITS_USERSPACEONUSE), t
            )
          })),
      ...
      (p.lineOutline =
        d(h, u, 'outline', null, 'lineOutlineEnabled', null, pe.lineOutlineEnabled) ||
        p.lineOutline),
      (p.lineOutline =
        d(h, u, 'outlineColor', null, 'lineOutlineColor', null, pe.lineOutlineColor, null, !0) ||
        p.lineOutline),
      (p.lineOutline =
      ...
      ['startPlugOutline', 'endPlugOutline'].forEach(function(e, t) {
        ;(p.plugOutline =
          d(h, u, e, null, 'plugOutlineEnabledSE', t, pe.plugOutlineEnabledSE[t]) || p.plugOutline),
          (p.plugOutline =
            d(h, u, e + 'Color', 'string', 'plugOutlineColorSE', t, null, null, !0) ||
            p.plugOutline),
          (p.plugOutline =
              ...
              We(a, o.gradient_colorSE, t, (n = i.gradient_colorSE[t])) &&
                ...
                ['x', 'y'].forEach(function(e) {
                  ;(n = i.gradient_pointSE[t][e]) !== o.gradient_pointSE[t][e] &&
                    (a.efc_gradient_gradient[e + (t + 1)].baseVal.value = o.gradient_pointSE[t][
                      e
                    ] = n)
                })
            })
            ...
            u =
              ...
              p
                ...
                : ((o.elmBlur = a.appendChild(e.createElementNS(b, 'feGaussianBlur'))),
                  ...
                  (o.styleFlood = i.style),
                  ((i = a.appendChild(e.createElementNS(b, 'feComposite'))).in2.baseVal =
                    'offsetblur'),
                  (i.operator.baseVal = SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_IN),
                  (i = a.appendChild(e.createElementNS(b, 'feMerge'))).appendChild(
                    e.createElementNS(b, 'feMergeNode')
                  ),
                  (i.appendChild(e.createElementNS(b, 'feMergeNode')).in1.baseVal =
                    'SourceGraphic')),
              o)
    ...
    (g = {
      none: {
        ...
        stop: function(e, t, n) {
          var a = e.curStats
          return (
            (n = null != n ? n : e.aplStats.show_on), (a.show_inAnim = !1), t && Ge(e, n), n ? 1 : 0
          )
        },
      },
      fade: {
          ...
          t.show_animId && c.remove(t.show_animId),
            (t.show_animId = c.add(
              ...
              function(e, t) {
                t
                  ? g.fade.stop(n, !0)
                  : ((n.svg.style.opacity = e + ''), le && (Ae(n, n.svg), Ve(n)))
              },
        ...
        update: function(t) {
          ...
          return (
            ...
            ['x', 'y', 'width', 'height'].forEach(function(e) {
              ;(n = C[e]) !== L[e] &&
                ((A[e] = L[e] = n),
                (V[oe[e]] = n + ('x' === e || 'y' === e ? t.bodyOffset[e] : 0) + 'px'))
            }),
      ...
      mouseHoverAnchor: {
        ...
        init: function(a, i) {
          ...
          return (
            ...
            'inline' ===
            (o = a.element.ownerDocument.defaultView.getComputedStyle(a.element, '')).display
            ...
            a.style.display &&
              ((n = a.element.style.display), (a.element.style.display = a.style.display)),
            y.mouseHoverAnchor.dirKeys.forEach(function(e) {
              var t = 'padding' + e[1]
